...
function LoginButton({
  ...
  return (
    <motion.button
      ref={btnRef}
      type="submit"
      className={`relative overflow-hidden mt-2 inline-flex min-h-14 w-full cursor-pointer items-center justify-center rounded-[10px] px-4 font-semibold ${invalid ? 'fieldReject' : ''}`}
      onClick={onClick}
      onHoverStart={() => {
      ...
      animate={{
        backgroundColor: success ? '#22c55e' : '#FF6B00',
        color: '#ffffff',
