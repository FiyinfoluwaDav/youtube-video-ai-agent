...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-20 text-center px-4 mt-80 md:mt-[28rem]">
        <motion.div
          ...
          <div className="flex justify-center mt-12">
            <div className="relative w-full max-w-2xl rounded-full p-[2px] overflow-hidden shadow-[0_0_30px_rgba(255,94,0,0.15)] group">
              ...
              <div className="relative w-full h-full bg-[#020810]/95 backdrop-blur-2xl rounded-full flex items-center overflow-hidden">
                ...
                />
                <button className="absolute right-3 top-1/2 -translate-y-1/2 bg-primary/80 hover:bg-primary text-white rounded-full p-3 md:p-3.5 transition-colors shadow-[0_0_15px_rgba(255,94,0,0.3)] flex items-center justify-center">
                  <svg
